...
test("the effort levels worked out for a model are the ones pi offers for it", async () => {
  ...
  const { getSupportedThinkingLevels } = await import(found.href);
  const { thinkingLevelsOf } = await import("../dist/pi/model-runtime.js");
