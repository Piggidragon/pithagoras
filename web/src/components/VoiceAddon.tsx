...
export function VoiceAddon({ onError }: { onError: (message: string) => void }) {
  ...
  return <div className="mt-4 space-y-4">
    ...
    {config.runtime === "chatterbox" && <p className="text-xs text-fg-faint">Chatterbox speaks your input language and clones the selected reference voice; it has no designed voice. Numbers are written out before synthesis so they are spoken correctly.</p>}
    </section>
